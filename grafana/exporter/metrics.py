...
foo = Enum(name='foo_health_status', documentation='FOO health', labelnames=healthcheck)
bar = Enum(name='bar_health_status', documentation='BAR health', labelnames=healthcheck)
baz = Enum(name='baz_health_status', documentation='BAZ health', labelnames=healthcheck)
